...
export default function App() {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-100 font-sans selection:bg-blue-500 selection:text-white pb-20">
            ...
            {/* Header */}
            <header className="bg-slate-950 border-b border-slate-800 p-6 shadow-lg sticky top-0 z-10">
                <div className="max-w-4xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-white rounded-lg shadow-lg">
                            <img src="./aione-logo.png" alt="AiONE Logo" className="w-20 h-auto" />
                        </div>
                        <div>
                            <h1 className="text-xl font-bold tracking-tight text-white">AI Agency Discovery <span className="text-blue-400 text-xs ml-2 border border-blue-500/30 rounded px-1.5 py-0.5">Gemini Powered</span></h1>
                            <p className="text-xs text-slate-400 font-medium tracking-widest uppercase">Auditoría de Eficiencia Operativa</p>
                        </div>
                    </div>
